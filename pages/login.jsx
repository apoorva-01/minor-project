    ...
    <ThemeProvider theme={theme}>
      ...
      <Grid container component="main" sx={{ height: '100vh' }}>
        <Grid container justifyContent='center' alignItems='center' item xs={false} sm={4} lg={7}>
         <Image src='/logo.png'width={400} height={400}alt={'IGSCS LOGO'} ></Image>
        </Grid>
        <Grid item xs={12} sm={8} lg={5} component={Paper} elevation={6} square>
          ...
          <form onSubmit={handleSubmit(submitHandler)} >
            ...
            >
             {/* <Image src='/logo.png'width={100} height={100}alt={'IGSCS LOGO'} ></Image> */}
              </Box>
              ...
              <Box sx={{ mt: 1 }}>
                ...
                />
                  ...
                  <Button className='hvr-grow' type="submit" 
                    style={{ width: '100%', backgroundColor: '#34481F', color: 'white', marginTop: '2rem', marginBottom: '2rem' }} >
                    Log In
                  </Button>
